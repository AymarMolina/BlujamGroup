  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.from(".hero-content > *", {
        y: 50, opacity: 0, duration: 1, stagger: 0.2, ease: "power4.out", delay: 0.3
      });
      ...
      gsap.from(".service-card", {
        ...
        y: 60, opacity: 1, duration: 0.8, stagger: 0.15, ease: "power2.out"
      });
      ...
      gsap.from(".mosaic-img", {
        scrollTrigger: { trigger: ".mosaic-container", start: "top 80%" },
        scale: 1.2, opacity: 0, duration: 1, stagger: 0.2, ease: "power2.out"
      });
      gsap.from(".testimonial-box", {
        scrollTrigger: { trigger: ".testimonial-box", start: "top 85%" },
    ...
    <main ref={containerRef} className="bg-[#000A15] text-white min-h-screen selection:bg-[#ff7a00] selection:text-white overflow-hidden">
      ...
      <style>{`
        @media (max-width: 1023px) {
          .nosotros-hero { padding-top: 7rem !important; padding-bottom: 3rem !important; }
          .nosotros-hero h1 { font-size: 2.25rem !important; margin-bottom: 1rem !important; }
          .nosotros-hero p.hero-desc { font-size: 1rem !important; }
          ...
          .nosotros-stats-wrap { grid-template-columns: 1fr !important; }
          .stats-container { padding: 2rem !important; }
          .stats-container .quote-text { font-size: 1.5rem !important; }
          .stats-container .stat-number { font-size: 2rem !important; }
          .mosaic-container { height: 280px; }
          .nosotros-banner { height: 35vh !important; }
        }
        @media (max-width: 639px) {
          .nosotros-hero h1 { font-size: 1.75rem !important; }
          .nosotros-hero h1 br { display: none; }
          .stats-container { padding: 1.25rem !important; }
          .stats-container .quote-text { font-size: 1.15rem !important; }
          .stats-grid { grid-template-columns: repeat(2, 1fr) !important; }
          .mosaic-container { height: 200px; }
        }
      `}</style>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-12 items-center relative z-10">
          <div className="md:col-span-7 text-center md:text-left hero-content">
            <div className="flex items-center gap-3 mb-6 justify-center md:justify-start">
              ...
              <span className="text-[#ff7a00] tracking-[3px] uppercase text-xs" style={{ fontFamily: "var(--font-michroma)" }}>
            ...
            <p
              className="hero-desc text-white text-xl md:text-2xl max-w-2xl leading-relaxed mx-auto md:mx-0"
          ...
          <div className="md:col-span-5 relative mt-12 md:mt-0 hero-image">
            ...
            >
              <Image src="/icons/servicios/serv2.webp" alt="Equipo Blujam" fill className="object-cover" priority />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-10">
          {[
            ...
            <div key={i} className="service-card p-9 rounded-2xl bg-white/5 border border-white/10 hover:border-[#ff7a00]/50 transition-all duration-500">
              <h3 className="text-xl font-bold mb-4 text-[#ff7a00] uppercase" style={{ fontFamily: "var(--font-michroma)" }}>
                {item.title}
              </h3>
              <p className="text-white text-lg leading-tight" style={{ fontFamily: "var(--font-rajdhani)" }}>
                {item.desc}
              </p>
            </div>
          ))}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="nosotros-stats-wrap bg-[#001E3C]/20 backdrop-blur-2xl border border-white/5 overflow-hidden grid lg:grid-cols-12">
            ...
            <div className="lg:col-span-7 p-12 md:p-16 space-y-10 stats-container">
              ...
              <p
                className="quote-text text-3xl md:text-5xl text-white italic leading-tight"
                style={{ fontFamily: "var(--font-rajdhani)" }}
              >
                "Nacimos con una visión clara: ofrecer soluciones innovadoras para desafíos únicos."
              </p>
              <div className="stats-grid grid grid-cols-3 gap-6 pt-10 border-t border-white/10">
                {[
                  ...
                  <div key={idx}>
                    ...
                    <p className="text-white text-sm uppercase tracking-wider mt-2" style={{ fontFamily: "var(--font-rajdhani)" }}>
                      {s.t}
                    </p>
                  </div>
                ))}
